      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
                ...
                <form method ="POST">
                  <div class="login-form ">
                    ...
                    <div class="form-group row login-tools">
                      ...
                      <div class="col-6 login-forgot-password"><a href="http://localhost/user_login/forgot-password.php">Forgot Password?</a></div>
                    </div>
            ...
            <div class="splash-footer">&copy; Railway Reservation System | Aishwarya Mazumder</div>
          </div>
        </div>
      </div>
    </div>
