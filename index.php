				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							<p>Best Way To Reserve Train Tickets!</a></p>
						</div>
					</section>
					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">01783651331</li>
								<li class="icon solid fa-envelope"><a href="#">aishwarya@gmail.com</a></li>
								
								<li class="icon brands fa-facebook-f"><a href="#">facebook.com</a></li>
								<li class="icon brands fa-instagram"><a href="#">instagram.com</a></li>
							</ul>
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Aishwarya Mazumder</li>
							</ul>
						</div>
					</section>
